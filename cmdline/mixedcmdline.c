	...
	char *progName)
{
	...
	while(cmd != NULL) {
		...
		case cmdFLAG:
	        ...
	        if(y==265)y=y-35;     /* back up since buttons are now row-wise */
 	        if(y==640)y=y-55;     /* back up since buttons are now row-wise */
                if(y==675)y=y-25;     /* back up since buttons are now row-wise */ 
			break;
