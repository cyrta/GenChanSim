...
/*
   ...
   $Id: airtoair.c,v LL0.0 3/1996 $
   $Log: airtoair.c,v $

 * Revision LL0.0 3/1996
 * Structured program for the air to air channel model.
 *
...
#define	TRIGSHFT	23	/* # of bits to shift index to get int
				 * portion */
#define	FILTBANK	"/MobileChan/PropChan/AirMobile/airtoair/tapwgts/dopp_filt.coef"	/* filter bank file */
#define	FLAT_FILTBANK	"/MobileChan/PropChan/AirMobile/airtoair/tapwgts/flat_filt.coef"	/* filter bank file */
#define	GAUSSIAN_FILTBANK  "/MobileChan/PropChan/AirMobile/airtoair/tapwgts/gaussian_filt.coef" 
/* filter bank file */
...
#define GAUSSIAN_IIR_WRM_FILE     "/MobileChan/PropChan/AirMobile/airtoair/tapwgts/iir_gaussian_warm.dat"
#define GAUSSIAN_INTERP_WRM_FILE  "/MobileChan/PropChan/AirMobile/airtoair/tapwgts/interp_gaussian_warm.dat"
