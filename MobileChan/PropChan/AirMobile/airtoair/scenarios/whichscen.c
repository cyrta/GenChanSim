/* Quieries the user on some scenario specifications and then advises
   ...
   $Id: whichscen.c,v 1.0 Apr 1996 cmk Exp $
   $Log: whichscen.c,v $
...
static char rcsid[] = "$Id: whichscen.c,v 1.0 Apr 1996 cmk Exp $";

enum geometry {NEAR, MEDIUM, FAR};
enum earthtype {LAND,SEA};
enum surfacetype {SMOOTH,AVERAGE,ROUGH};
...
char *argv[];
{
  ...
  Enterearth:{
    fprintf(stderr,"Enter whether aircraft are over land or sea:\n 0=land\n 1=sea\n ? ");
  ...
  /* check if valid earthtype */
    ...
    case LAND:
      /* Aircraft over land */
      fprintf(stdout,"Aircraft over LAND\n\n");
      *begfname="land";
      break;
    case SEA:
      /* Aircraft over sea */
      fprintf(stdout,"Aircraft over SEA\n\n");
      *begfname="sea";
      break;
    default:
  ...
  Entergeom:{
    fprintf(stderr,"Enter the aircraft geometry and velocity configuration:\n 0=near\n 1=medium\n 2=far\n ? ");
    fscanf(stdin,"%d",&geom);
    ...
    case NEAR:
      /* aircraft are near */
      fprintf(stdout,"Aircraft are at NEAR range.\n\n");
      *midfname="near";
      break;
    case MEDIUM:
      /* aircraft are at medium range */
      fprintf(stdout,"Aircraft are at MEDIUM range.\n\n");
      *midfname="med";
      break;
    case FAR:
      /* Aircraft are far */
      fprintf(stdout,"Aircraft are at FAR range.\n\n");
      *midfname="far";
      break;
    default:
