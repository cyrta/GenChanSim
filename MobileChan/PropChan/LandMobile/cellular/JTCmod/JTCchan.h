...
/*
   ...
   $Id: JTCchan.h,v 3.0 1994/08/31 19:07:06 jjb Exp $
   $Log: mobilechan.h,v $

 * Lincoln Lab Revision 12/1995 Linda Riehl and Cathy Keller
 * changed MAXTAPS from 200 to 400
 * added parameters necessary for allowing a data file with delay
 * power spectrum samples and a data file with doppler power spectrum
...
#define	TRIGSHFT	23	/* # of bits to shift index to get int
				 * portion */
#define	FILTBANK	"/MobileChan/PropChan/LandMobile/cellular/JTCmod/tapwgts/dopp_filt.coef"	/* filter bank file */
#define	FLAT_FILTBANK	"/MobileChan/PropChan/LandMobile/cellular/JTCmod/tapwgts/flat_filt.coef"	/* filter bank file */
...
#define FLAT_IIR_WRM_FILE     "/MobileChan/PropChan/LandMobile/cellular/JTCmod/tapwgts/iir_flat_warm.dat"
#define JAKES_IIR_WRM_FILE    "/MobileChan/PropChan/LandMobile/cellular/JTCmod/tapwgts/iir_jakes_warm.dat"
#define DATA_IIR_WRM_FILE    "/MobileChan/PropChan/LandMobile/cellular/JTCmod/tapwgts/iir_data_warm.dat"
#define FLAT_INTERP_WRM_FILE  "/MobileChan/PropChan/LandMobile/cellular/JTCmod/tapwgts/interp_flat_warm.dat"
#define JAKES_INTERP_WRM_FILE "/MobileChan/PropChan/LandMobile/cellular/JTCmod/tapwgts/interp_jakes_warm.dat"
#define DATA_INTERP_WRM_FILE "/MobileChan/PropChan/LandMobile/cellular/JTCmod/tapwgts/interp_data_warm.dat"
