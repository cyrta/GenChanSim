...
/*
   ...
   $Id: mobilechan.h,v 3.0 1994/08/31 19:07:06 jjb Exp $
   $Log: mobilechan.h,v $
...
#define	TRIGSHFT	23	/* # of bits to shift index to get int
				 * portion */
#define	FILTBANK	"/mobilechan/tapwgts/dopp_filt.coef"	/* filter bank file */
#define	FLAT_FILTBANK	"/mobilechan/tapwgts/flat_filt.coef"	/* filter bank file */
...
#define FLAT_IIR_WRM_FILE     "/mobilechan/tapwgts/iir_flat_warm.dat"
#define JAKES_IIR_WRM_FILE    "/mobilechan/tapwgts/iir_jakes_warm.dat"
#define FLAT_INTERP_WRM_FILE  "/mobilechan/tapwgts/interp_flat_warm.dat"
#define JAKES_INTERP_WRM_FILE "/mobilechan/tapwgts/interp_jakes_warm.dat"
